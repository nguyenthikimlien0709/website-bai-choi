...
export const CARD_ASSETS = [
  ...
  { src: '/assets/the6.jpg', alt: 'Thẻ bài Lục Xơ' },
  { src: '/assets/the7.jpg', alt: 'Thẻ bài Thất Nhọn' },
  { src: '/assets/the8.jpg', alt: 'Thẻ bài Bát Bồng' },
  { src: '/assets/the9.jpg', alt: 'Thẻ bài Cửu Thầy' },
  { src: '/assets/the10.jpg', alt: 'Thẻ bài Thái Tử' },
] as const
